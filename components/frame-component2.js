...
const FrameComponent2 = ({
  ...
  const packagesAndDiscountsStyle = useMemo(() => {
    return {
      debugCommit: propDebugCommit,
      paddingRight: propPaddingRight,
    };
  }, [propDebugCommit, propPaddingRight]);
  ...
  return (
    <div className="self-stretch flex flex-row items-start justify-start py-0 pr-5 pl-4 box-border max-w-full text-left text-5xl text-dark font-light-basic-typography-paragraph">
      <div className="flex-1 rounded-md shadow-[0px_2px_4px_rgba(165,_163,_174,_0.3)] overflow-hidden flex flex-row flex-wrap items-start justify-start py-3 px-0 box-border gap-[10px] max-w-full">
        <div
          className="flex-1 flex flex-col items-start justify-start pt-2 px-0 pb-0 box-border min-w-[656px] max-w-full mq750:min-w-full"
          style={frameDiv5Style}
        >
          <h2
            className="m-0 self-stretch relative text-inherit leading-[22px] font-semibold font-inherit shrink-0 [debug_commit:f6aba90] mq450:text-lgi mq450:leading-[18px]"
            style={packagesAndDiscountsStyle}
          >
        ...
        />
        <div
          className="flex flex-row items-start justify-start gap-[25.600000000000364px] shrink-0 [debug_commit:f6aba90] text-center text-smi text-light-solid-color-extra-card-background"
