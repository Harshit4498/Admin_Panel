...
const Navbar2 = () => {
  ...
  return (
    <div className="self-stretch rounded-md shadow-[0px_2px_4px_rgba(165,_163,_174,_0.3)] overflow-hidden flex flex-row flex-wrap items-start justify-start py-3 pr-1 pl-0 box-border gap-[10px] max-w-full text-left text-5xl text-dark font-light-basic-typography-paragraph">
      <div className="flex-1 flex flex-col items-start justify-start pt-2 px-0 pb-0 box-border min-w-[667px] max-w-full mq750:min-w-full">
        <h2 className="m-0 self-stretch relative text-inherit leading-[22px] font-semibold font-inherit mq450:text-lgi mq450:leading-[18px]">
          Activity logs
        </h2>
      </div>
      <img
      ...
      />
      <div className="flex flex-row items-start justify-start gap-[25.599999999998545px] text-center text-smi text-light-solid-color-extra-card-background">
