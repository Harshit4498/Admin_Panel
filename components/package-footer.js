const PackageFooter = () => {
  return (
    <div className="absolute top-[1343px] left-[16px] w-[1112px] flex flex-row items-center justify-between py-[30px] px-10 box-border gap-[20px] max-w-full z-[1] text-left text-sm text-darkslategray font-inter mq750:flex-wrap">
